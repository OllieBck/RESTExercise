...
void httpRequest(){
  // Make a HTTP request:
    int redColor = map(analogRead(A0), 0, 1023, 0, 255);
    int greenColor = map(analogRead(A1), 0, 1023, 0, 255);
    int blueColor = map(analogRead(A2), 0, 1023, 0, 255);
    client.print("POST /color/");
    client.print("r/");
    client.print(redColor);
    client.print("/g/");
    client.print(greenColor);
    client.print("/b/");
    client.print(blueColor);
